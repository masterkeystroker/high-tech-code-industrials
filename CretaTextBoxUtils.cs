...
namespace CretaBase
{
    static public class CretaTextBoxUtils
    {
        #region IsNumericOnly
        /// <summary>
        /// TextBox Attached Dependency Property
        /// </summary>
        public static readonly DependencyProperty IsNumericOnlyProperty = DependencyProperty.RegisterAttached("IsNumericOnly", typeof(bool), typeof(CretaTextBoxUtils), new UIPropertyMetadata(false, OnIsNumericOnlyChanged));
        ...
        private static void BlockNonDigitCharacters(object sender, TextCompositionEventArgs e)
        {
            ...
            {
                bool bValid = Char.IsDigit(ch) || ch=='.' || ch=='-';
                if (!bValid)
                {
                    e.Handled = true;
                }
